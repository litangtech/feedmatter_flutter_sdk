...
class FeedMatterAllFeedbacksTab extends StatefulWidget {
  ...
  const FeedMatterAllFeedbacksTab({
    super.key,
  ...
  @override
  FeedMatterAllFeedbacksTabState createState() =>
      FeedMatterAllFeedbacksTabState();
}

class FeedMatterAllFeedbacksTabState extends State<FeedMatterAllFeedbacksTab>
  ...
  Future<void> _loadFeedbacks() async {
    ...
    try {
      ...
      final keyword = trimmedKeyword.isEmpty ? null : trimmedKeyword;
      final feedbacks = await fm.FeedMatterClient.instance.getFeedbacks(
        size: 30,
        keyword: keyword,
      );
      if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: FeedMatterFeedbackTabList(
